...
UIEntity::UIEntity(GameCore *game_core, const UIEntityArgs &args) : Entity2D(game_core, static_cast<Entity2DArgs>(args)) {
    this->_ui_transform_component = this->create_component<UITransformComponent>(static_cast<UITransformComponentArgs>(args));
