...
class AnimationComponent : public BehaviorComponent {
   public:
    ...
    struct Animation {
        ...
        Animation(std::function<void()> &&animation, double duration, AnimationState next_animation_state = IDLE)
            : _duration(duration),
              _end_time(0.0),
    ...
    inline AnimationState get_animation_state() { return this->_current_animation_state; }
   ...
   protected:
    ...
    void register_animation(AnimationState state,
                            ...
                            void (Type::*method)(),
                            double duration,
                            AnimationState next_animation_state) {
   ...
   private:
    ...
    std::unordered_map<AnimationState, Animation> _animations;
