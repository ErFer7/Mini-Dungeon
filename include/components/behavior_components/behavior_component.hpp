...
class BehaviorComponent : public Component {
   ...
   public:
    BehaviorComponent(Entity *entity) : Component(entity) { utils::log_trace(this, __PRETTY_FUNCTION__, entity); }

    BehaviorComponent(BehaviorComponent &&other) = default;

    ~BehaviorComponent() override { utils::log_trace(this, __PRETTY_FUNCTION__); };
